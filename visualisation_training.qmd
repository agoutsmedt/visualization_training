...
data_ispole2 %>%
  ...
  geom_line(
    show.legend = F, size = 1.2 # ,fill="grey"
  ) +
  xlim(2010, 2024) +
  ...
  facet_wrap(
    . ~ type_de_publication_en # ,scale="free_y"
  ) +
  scale_color_jco()
```
